...
export function useService(serviceIdentifier, opts) {
    var ref = useRef(null);
    try {
        ref.current = useContext(Context).get(serviceIdentifier, opts);
    }
    catch (e) {
...
var RouterService = (function () {
    ...
    RouterService.middleElements = function (container) {
        try {
            return container.get(ReactRouter.middleElements);
        }
        catch (_a) {
            return [];
        }
            ...
            if (RouteDecorate === null || RouteDecorate === void 0 ? void 0 : RouteDecorate.metadata) {
                ...
                return __assign(__assign({}, rest), { ErrorBoundary: ErrorBoundary !== null && ErrorBoundary !== void 0 ? ErrorBoundary : (container.isBound(ReactRouter.ErrorBoundary) ? container.get(ReactRouter.ErrorBoundary) : undefined), element: createElement((function () {
                        ...
                        return createElement(Context.Provider, {
                            value: container,
                            children: _this.toElement(RouterService_1.middleElements(container), Component_1 ? createElement(Component_1) : createElement(Outlet))
                        });
    ...
    RouterService.prototype.getRouter = function () {
        ...
        if (decorate instanceof GeckoBrowserRouterDecorate) {
            return createBrowserRouter(RouterService_1.getRoutes(containers), decorate.metadata);
        }
        if (decorate instanceof GeckoHashRouterDecorate) {
            return createHashRouter(RouterService_1.getRoutes(containers), decorate.metadata);
        }
